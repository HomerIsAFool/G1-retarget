...
if __name__ == "__main__":
    ...
    parser.add_argument("--amass_root", type=str, default="/home/yuji/yuji/human2humanoid/data/AMASS/AMASS_Complete")
    ...
    for data_key in pbar:
        ...
        joblib.dump(data_dump, "data/h1/test_my_own_data_20250314.pkl")
    
        
    # import ipdb; ipdb.set_trace()
    joblib.dump(data_dump, "data/h1/amass_all_my_own_data_20250314.pkl")