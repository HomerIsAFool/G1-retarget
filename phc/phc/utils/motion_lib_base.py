...
class MotionLibBase():
    ...
    def load_data(self, motion_file,  min_length=-1, im_eval = False):
        ...
        if self.mode == MotionlibMode.file:
            ...
            #print("type(data_list):",type(data_list))#dict
            
            # data_list.pop('0-BioMotionLab_NTroje_rub023_0016_sitting2_poses')
            # data_list.pop('0-BioMotionLab_NTroje_rub023_0014_knocking2_poses')
            print("len(data_list):",len(data_list))
        ...
        if self.mode == MotionlibMode.directory:
            ...
            self._motion_data_load = joblib.load("legged_gym/resources/motions/h1/amass_phc_filtered.pkl") # set self._motion_data_load to a sample of the data 
