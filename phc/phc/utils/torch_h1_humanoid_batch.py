...
class Humanoid_Batch:
    ...
    def __init__(self, mjcf_file = f"/home/yuji/yuji/human2humanoid/resources/robots/h1/xml/h1.xml", extend_hand = True, extend_head = False, device = torch.device("cpu")):
